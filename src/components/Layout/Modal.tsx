...
export default function Modal({ title, isOpen, openModal, closeModal, children, className = 'w-full max-w-sm' }) {
          ...
          <Transition.Child
            ...
            <div
              ...
              <div className="flex justify-between pb-2">
                <Dialog.Title as="h3" className="text-lg leading-tight font-bold">
                  {title}
                </Dialog.Title>
                <button
                  type="button"
